...
### Added
- `find -i`/`--ignore-case` matches case-insensitively, so `find readme` finds `README.md`
  without remembering the exact casing. Works in both substring and glob mode.
